...
def split_data(pp_data, val_size=0.1, r_seed=RANDOM_SEED):
    '''
    Funcao que realiza a adequacao final dos dados para o uso pela rede. Separa
    ...
    for epoch in range(1000):
        ...
        if epoch % 100 == 0:
            ...
            if verbose:
                ...
                print('Training set loss: {0:.4f} accuracy: {1:.4f}'.\
                    format(tr_lss, tr_acc))
                print('Validation set loss: {0:.4f} accuracy: {1:.4f}'.\
                    format(vl_lss, vl_acc))
